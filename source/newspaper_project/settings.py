...
SECRET_KEY = "django-insecure-p&g&oe4675*xyp84ksj3jgn_4ef)zw)mjir_q$*xs@*7$al29+"
...
TEMPLATES = [
    {
        ...
        "DIRS": [Path(BASE_DIR, "templates")],  # add custom templates
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
EMAIL_BACKEND = (
    "django.core.mail.backends.console.EmailBackend"  # console reset password
)
